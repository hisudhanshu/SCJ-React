...
import { Col, Row, Table, Image, Container, card } from '@themesberg/react-bootstrap';
    ...
    <Container className="px-0">
      <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
        <Col className="d-block mb-4 mb-md-0">
          <h3 className="h3">
            <strong style={{ fontFamily: 'fGeorgia Times New Roman Times, serif' }}>View Material</strong>
          </h3>
        </Col>
      </Row>
